"""
Auto-Forward System - Forward ALL user files to channel
...
async def forward_file_to_channel(context, user, file_message):
    """
    Forward ANY user's leeched file to backup channel
    REMOVED: Owner-only check - now forwards from ALL users
    """
    ...
    try:
        # Copy message from user's chat to the backup channel
